...
This repository contains comprehensive assignments from the 10Pearls QA Internship (Cohort 8), demonstrating expertise in manual testing, API testing, and test automation. It includes requirement analysis, test planning, bug reporting, API testing frameworks, and end-to-end automation scripts.
...
Each assignment folder contains specific project files, test cases, automation scripts, and documentation. Refer to individual assignment folders for detailed setup instructions and execution guidelines.

---

**Internship Period:** 10Pearls Internship (Cohort 8)  
**Focus Area:** Quality Assurance & Test Automation
